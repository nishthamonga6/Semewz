...
export default function JeansPage() {
  ...
  const allProducts = products.jeans
    ...
    <div className="min-h-screen bg-[#F2D3C5]">
      ...
      <div className="container mx-auto px-4 lg:px-8 py-4 border-b border-gray-200">
        <div className="flex items-center gap-2 text-sm text-gray-600">
          ...
          <span>/</span>
          <span className="text-semwz-black font-medium">Jeans</span>
        </div>
      </div>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2">
                  {[
                    { range: [0, 2000], label: 'Under ₹2000' },
                    { range: [2000, 2500], label: '₹2000 - ₹2500' },
                    { range: [2500, 3000], label: '₹2500 - ₹3000' },
                    { range: [3000, 5000], label: '₹3000 - ₹5000' },
                  ].map((filter) => (
              ...
              {/* Fit Filter */}
              <div className="space-y-3">
                <h4 className="font-semibold text-sm text-semwz-black">Fit</h4>
                <ul className="space-y-2 text-sm text-gray-700">
                  <li className="hover:text-semwz-black cursor-pointer">Slim Fit</li>
                  <li className="hover:text-semwz-black cursor-pointer">Straight Fit</li>
                  <li className="hover:text-semwz-black cursor-pointer">Wide Leg</li>
                  <li className="hover:text-semwz-black cursor-pointer">Utility</li>
                </ul>
              </div>
              ...
              <div className="space-y-3">
                ...
                <ul className="space-y-2 text-sm text-gray-700">
                  <li className="hover:text-semwz-black cursor-pointer">Deep Blue</li>
                  <li className="hover:text-semwz-black cursor-pointer">Black</li>
                  <li className="hover:text-semwz-black cursor-pointer">Light Indigo</li>
                  <li className="hover:text-semwz-black cursor-pointer">Stone Wash</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-3">
            ...
            <div className="flex items-center justify-between mb-6 pb-4 border-b border-gray-200">
              <div className="text-sm text-gray-600">
                Showing <span className="font-semibold">{paginatedProducts.length}</span> results from total <span className="font-semibold">{sortedProducts.length}</span> for "Jeans"
              </div>
