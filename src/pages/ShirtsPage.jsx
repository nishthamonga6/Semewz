        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:sticky lg:top-24">
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2">
                  {[
                    ...
                    { range: [1000, 1500], label: '₹1000 - ₹1500' },
                    { range: [1500, 2000], label: '₹1500 - ₹2000' },
              ...
              {/* Type Filter */}
              <div className="space-y-3">
                <h4 className="font-semibold text-sm text-semwz-black">Type</h4>
                <ul className="space-y-2 text-sm text-gray-700">
                  <li className="hover:text-semwz-black cursor-pointer">T-Shirts</li>
                  <li className="hover:text-semwz-black cursor-pointer">Casual Shirts</li>
                  <li className="hover:text-semwz-black cursor-pointer">Linen Shirts</li>
                  <li className="hover:text-semwz-black cursor-pointer">Crop Tops</li>
                </ul>
              </div>
              ...
              <div className="space-y-3">
                ...
                <ul className="space-y-2 text-sm text-gray-700">
                  <li className="hover:text-semwz-black cursor-pointer">White</li>
