...
export default function NewArrivalsPage() {
  ...
  const allProducts = products.new
    ...
    <div className="min-h-screen bg-[#F2D3C5]">
      ...
      <div className="container mx-auto px-4 lg:px-8 py-4 border-b border-gray-200">
        <div className="flex items-center gap-2 text-sm text-gray-600">
          ...
          <span>/</span>
          <span className="text-semwz-black font-medium">New Arrivals</span>
        </div>
      </div>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2">
                  {[
                    { range: [0, 1000], label: 'Under ₹1000' },
                    { range: [1000, 2000], label: '₹1000 - ₹2000' },
                    { range: [2000, 3000], label: '₹2000 - ₹3000' },
              ...
              {/* Category Filter */}
              <div className="space-y-3">
                <h4 className="font-semibold text-sm text-semwz-black">Category</h4>
                <ul className="space-y-2 text-sm text-gray-700">
                  <li className="hover:text-semwz-black cursor-pointer">All Products</li>
                  <li className="hover:text-semwz-black cursor-pointer">Shirts</li>
                  <li className="hover:text-semwz-black cursor-pointer">Jeans</li>
                  <li className="hover:text-semwz-black cursor-pointer">Co-ord Sets</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-3">
            ...
            <div className="flex items-center justify-between mb-6 pb-4 border-b border-gray-200">
              <div className="text-sm text-gray-600">
                Showing <span className="font-semibold">{paginatedProducts.length}</span> results from total <span className="font-semibold">{sortedProducts.length}</span> for "New Arrivals"
              </div>
