 ...
 */
/** Multiple rows differ by photo angle (e.g. full look vs close-up), not colour */
export const variantsArePhotoViews = (variants) =>
  Array.isArray(variants) &&
  variants.length > 1 &&
  variants.every((v) => v.viewLabel);
    ...
    return {
      ...
      color:
        variants.length > 1
          ...
          : representative.viewLabel || representative.color,
      sizes: allSizes,
      variants,
    };
  });
